...
public class repr extends java.lang.Object {
    ...
    public static class _PyInner extends PyFunctionTable implements PyRunnable {
        ...
        private static void initConstants() {
            ...
            s$36 = Py.newString(">");
            s$37 = Py.newString("/usr/local/jython21/Lib/repr.py");
            funcTable = new _PyInner();
            c$0___init__ = Py.newCode(1, new String[] {"self"}, "/usr/local/jython21/Lib/repr.py", "__init__", false, false, funcTable, 0, null, null, 0, 1);
            c$1_repr = Py.newCode(2, new String[] {"self", "x"}, "/usr/local/jython21/Lib/repr.py", "repr", false, false, funcTable, 1, null, null, 0, 1);
            c$2_repr1 = Py.newCode(3, new String[] {"self", "x", "level", "j", "parts", "i", "typename", "s"}, "/usr/local/jython21/Lib/repr.py", "repr1", false, false, funcTable, 2, null, null, 0, 1);
            c$3_repr_tuple = Py.newCode(3, new String[] {"self", "x", "level", "n", "i", "s"}, "/usr/local/jython21/Lib/repr.py", "repr_tuple", false, false, funcTable, 3, null, null, 0, 1);
            c$4_repr_list = Py.newCode(3, new String[] {"self", "x", "level", "n", "i", "s"}, "/usr/local/jython21/Lib/repr.py", "repr_list", false, false, funcTable, 4, null, null, 0, 1);
            c$5_repr_dictionary = Py.newCode(3, new String[] {"self", "x", "level", "n", "i", "key", "keys", "s"}, "/usr/local/jython21/Lib/repr.py", "repr_dictionary", false, false, funcTable, 5, null, null, 0, 1);
            c$6_repr_string = Py.newCode(3, new String[] {"self", "x", "level", "j", "i", "s"}, "/usr/local/jython21/Lib/repr.py", "repr_string", false, false, funcTable, 6, null, null, 0, 1);
            c$7_repr_long_int = Py.newCode(3, new String[] {"self", "x", "level", "j", "i", "s"}, "/usr/local/jython21/Lib/repr.py", "repr_long_int", false, false, funcTable, 7, null, null, 0, 1);
            c$8_repr_instance = Py.newCode(3, new String[] {"self", "x", "level", "j", "i", "s"}, "/usr/local/jython21/Lib/repr.py", "repr_instance", false, false, funcTable, 8, null, null, 0, 1);
            c$9_Repr = Py.newCode(0, new String[] {}, "/usr/local/jython21/Lib/repr.py", "Repr", false, false, funcTable, 9, null, null, 0, 0);
            c$10_main = Py.newCode(0, new String[] {}, "/usr/local/jython21/Lib/repr.py", "main", false, false, funcTable, 10, null, null, 0, 0);
        }
    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        Py.runMain(repr._PyInner.class, newargs, repr.jpy$packages, repr.jpy$mainProperties, "", new String[] {"repr", "string", "go", "copy"});
    }
