...
public class string extends java.lang.Object {
    ...
    public static class _PyInner extends PyFunctionTable implements PyRunnable {
        ...
        private static void initConstants() {
            ...
            s$49 = Py.newString("/usr/local/jython21/Lib/string.py");
            funcTable = new _PyInner();
            c$0_lower = Py.newCode(1, new String[] {"s"}, "/usr/local/jython21/Lib/string.py", "lower", false, false, funcTable, 0, null, null, 0, 1);
            c$1_upper = Py.newCode(1, new String[] {"s"}, "/usr/local/jython21/Lib/string.py", "upper", false, false, funcTable, 1, null, null, 0, 1);
            c$2_swapcase = Py.newCode(1, new String[] {"s"}, "/usr/local/jython21/Lib/string.py", "swapcase", false, false, funcTable, 2, null, null, 0, 1);
            c$3_strip = Py.newCode(1, new String[] {"s"}, "/usr/local/jython21/Lib/string.py", "strip", false, false, funcTable, 3, null, null, 0, 1);
            c$4_lstrip = Py.newCode(1, new String[] {"s"}, "/usr/local/jython21/Lib/string.py", "lstrip", false, false, funcTable, 4, null, null, 0, 1);
            c$5_rstrip = Py.newCode(1, new String[] {"s"}, "/usr/local/jython21/Lib/string.py", "rstrip", false, false, funcTable, 5, null, null, 0, 1);
            c$6_split = Py.newCode(3, new String[] {"s", "sep", "maxsplit"}, "/usr/local/jython21/Lib/string.py", "split", false, false, funcTable, 6, null, null, 0, 1);
            c$7_join = Py.newCode(2, new String[] {"words", "sep"}, "/usr/local/jython21/Lib/string.py", "join", false, false, funcTable, 7, null, null, 0, 1);
            c$8_index = Py.newCode(2, new String[] {"s", "args"}, "/usr/local/jython21/Lib/string.py", "index", true, false, funcTable, 8, null, null, 0, 1);
            c$9_rindex = Py.newCode(2, new String[] {"s", "args"}, "/usr/local/jython21/Lib/string.py", "rindex", true, false, funcTable, 9, null, null, 0, 1);
            c$10_count = Py.newCode(2, new String[] {"s", "args"}, "/usr/local/jython21/Lib/string.py", "count", true, false, funcTable, 10, null, null, 0, 1);
            c$11_find = Py.newCode(2, new String[] {"s", "args"}, "/usr/local/jython21/Lib/string.py", "find", true, false, funcTable, 11, null, null, 0, 1);
            c$12_rfind = Py.newCode(2, new String[] {"s", "args"}, "/usr/local/jython21/Lib/string.py", "rfind", true, false, funcTable, 12, null, null, 0, 1);
            c$13_atof = Py.newCode(1, new String[] {"s"}, "/usr/local/jython21/Lib/string.py", "atof", false, false, funcTable, 13, null, null, 0, 1);
            c$14_atoi = Py.newCode(1, new String[] {"args", "s"}, "/usr/local/jython21/Lib/string.py", "atoi", true, false, funcTable, 14, null, null, 0, 1);
            c$15_atol = Py.newCode(1, new String[] {"args", "s"}, "/usr/local/jython21/Lib/string.py", "atol", true, false, funcTable, 15, null, null, 0, 1);
            c$16_ljust = Py.newCode(2, new String[] {"s", "width", "n"}, "/usr/local/jython21/Lib/string.py", "ljust", false, false, funcTable, 16, null, null, 0, 1);
            c$17_rjust = Py.newCode(2, new String[] {"s", "width", "n"}, "/usr/local/jython21/Lib/string.py", "rjust", false, false, funcTable, 17, null, null, 0, 1);
            c$18_center = Py.newCode(2, new String[] {"s", "width", "half", "n"}, "/usr/local/jython21/Lib/string.py", "center", false, false, funcTable, 18, null, null, 0, 1);
            c$19_zfill = Py.newCode(2, new String[] {"x", "width", "sign", "s", "n"}, "/usr/local/jython21/Lib/string.py", "zfill", false, false, funcTable, 19, null, null, 0, 1);
            c$20_expandtabs = Py.newCode(2, new String[] {"s", "tabsize", "line", "res", "c"}, "/usr/local/jython21/Lib/string.py", "expandtabs", false, false, funcTable, 20, null, null, 0, 1);
            c$21_translate = Py.newCode(3, new String[] {"s", "table", "deletions"}, "/usr/local/jython21/Lib/string.py", "translate", false, false, funcTable, 21, null, null, 0, 1);
            c$22_capitalize = Py.newCode(1, new String[] {"s"}, "/usr/local/jython21/Lib/string.py", "capitalize", false, false, funcTable, 22, null, null, 0, 1);
            c$23_capwords = Py.newCode(2, new String[] {"s", "sep"}, "/usr/local/jython21/Lib/string.py", "capwords", false, false, funcTable, 23, null, null, 0, 1);
            c$24_maketrans = Py.newCode(2, new String[] {"fromstr", "tostr", "i", "L"}, "/usr/local/jython21/Lib/string.py", "maketrans", false, false, funcTable, 24, null, null, 0, 1);
            c$25_replace = Py.newCode(4, new String[] {"s", "old", "new", "maxsplit"}, "/usr/local/jython21/Lib/string.py", "replace", false, false, funcTable, 25, null, null, 0, 1);
            c$26_main = Py.newCode(0, new String[] {}, "/usr/local/jython21/Lib/string.py", "main", false, false, funcTable, 26, null, null, 0, 0);
        }
    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        Py.runMain(string._PyInner.class, newargs, string.jpy$packages, string.jpy$mainProperties, "", new String[] {"repr", "string", "go", "copy"});
    }
