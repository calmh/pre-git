...
public class copy extends java.lang.Object {
    ...
    public static class _PyInner extends PyFunctionTable implements PyRunnable {
        ...
        private static void initConstants() {
            ...
            s$29 = Py.newString("/usr/local/jython21/Lib/copy.py");
            funcTable = new _PyInner();
            c$0_Error = Py.newCode(0, new String[] {}, "/usr/local/jython21/Lib/copy.py", "Error", false, false, funcTable, 0, null, null, 0, 0);
            c$1_copy = Py.newCode(1, new String[] {"x", "copier", "copierfunction", "y"}, "/usr/local/jython21/Lib/copy.py", "copy", false, false, funcTable, 1, null, null, 0, 1);
            c$2__copy_atomic = Py.newCode(1, new String[] {"x"}, "/usr/local/jython21/Lib/copy.py", "_copy_atomic", false, false, funcTable, 2, null, null, 0, 1);
            c$3__copy_list = Py.newCode(1, new String[] {"x"}, "/usr/local/jython21/Lib/copy.py", "_copy_list", false, false, funcTable, 3, null, null, 0, 1);
            c$4__copy_tuple = Py.newCode(1, new String[] {"x"}, "/usr/local/jython21/Lib/copy.py", "_copy_tuple", false, false, funcTable, 4, null, null, 0, 1);
            c$5__copy_dict = Py.newCode(1, new String[] {"x"}, "/usr/local/jython21/Lib/copy.py", "_copy_dict", false, false, funcTable, 5, null, null, 0, 1);
            c$6__copy_inst = Py.newCode(1, new String[] {"x", "args", "state", "y"}, "/usr/local/jython21/Lib/copy.py", "_copy_inst", false, false, funcTable, 6, null, null, 0, 1);
            c$7_deepcopy = Py.newCode(2, new String[] {"x", "memo", "copier", "copierfunction", "d", "y"}, "/usr/local/jython21/Lib/copy.py", "deepcopy", false, false, funcTable, 7, null, null, 0, 1);
            c$8__deepcopy_atomic = Py.newCode(2, new String[] {"x", "memo"}, "/usr/local/jython21/Lib/copy.py", "_deepcopy_atomic", false, false, funcTable, 8, null, null, 0, 1);
            c$9__deepcopy_list = Py.newCode(2, new String[] {"x", "memo", "a", "y"}, "/usr/local/jython21/Lib/copy.py", "_deepcopy_list", false, false, funcTable, 9, null, null, 0, 1);
            c$10__deepcopy_tuple = Py.newCode(2, new String[] {"x", "memo", "i", "d", "y", "a"}, "/usr/local/jython21/Lib/copy.py", "_deepcopy_tuple", false, false, funcTable, 10, null, null, 0, 1);
            c$11__deepcopy_dict = Py.newCode(2, new String[] {"x", "memo", "key", "y"}, "/usr/local/jython21/Lib/copy.py", "_deepcopy_dict", false, false, funcTable, 11, null, null, 0, 1);
            c$12__keep_alive = Py.newCode(2, new String[] {"x", "memo"}, "/usr/local/jython21/Lib/copy.py", "_keep_alive", false, false, funcTable, 12, null, null, 0, 1);
            c$13__deepcopy_inst = Py.newCode(2, new String[] {"x", "memo", "state", "args", "y"}, "/usr/local/jython21/Lib/copy.py", "_deepcopy_inst", false, false, funcTable, 13, null, null, 0, 1);
            c$14__EmptyClass = Py.newCode(0, new String[] {}, "/usr/local/jython21/Lib/copy.py", "_EmptyClass", false, false, funcTable, 14, null, null, 0, 0);
            c$15___del__ = Py.newCode(1, new String[] {"self"}, "/usr/local/jython21/Lib/copy.py", "__del__", false, false, funcTable, 15, null, null, 0, 1);
            c$16__EmptyClassDel = Py.newCode(0, new String[] {}, "/usr/local/jython21/Lib/copy.py", "_EmptyClassDel", false, false, funcTable, 16, null, null, 0, 0);
            c$17___init__ = Py.newCode(2, new String[] {"self", "arg", "file", "sys"}, "/usr/local/jython21/Lib/copy.py", "__init__", false, false, funcTable, 17, null, null, 0, 1);
            c$18___getstate__ = Py.newCode(1, new String[] {"self"}, "/usr/local/jython21/Lib/copy.py", "__getstate__", false, false, funcTable, 18, null, null, 0, 1);
            c$19___setstate__ = Py.newCode(2, new String[] {"self", "state", "key"}, "/usr/local/jython21/Lib/copy.py", "__setstate__", false, false, funcTable, 19, null, null, 0, 1);
            c$20___deepcopy__ = Py.newCode(2, new String[] {"self", "memo", "new"}, "/usr/local/jython21/Lib/copy.py", "__deepcopy__", false, false, funcTable, 20, null, null, 0, 1);
            c$21_C = Py.newCode(0, new String[] {}, "/usr/local/jython21/Lib/copy.py", "C", false, false, funcTable, 21, null, null, 0, 0);
            c$22__test = Py.newCode(0, new String[] {"C", "l3", "l2", "repr", "l", "l1", "c"}, "/usr/local/jython21/Lib/copy.py", "_test", false, false, funcTable, 22, null, null, 0, 1);
            c$23_main = Py.newCode(0, new String[] {}, "/usr/local/jython21/Lib/copy.py", "main", false, false, funcTable, 23, null, null, 0, 0);
        }
    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        Py.runMain(copy._PyInner.class, newargs, copy.jpy$packages, copy.jpy$mainProperties, "", new String[] {"repr", "string", "go", "copy"});
    }
